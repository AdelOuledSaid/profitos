...
def test_v169_ui():
    ...
    for x in ['AI CFO · EXPLAINABLE PLANNER','Financement maximum accepté','Décision au plus tard','TOP 3 · PLANS COMPATIBLES','TOP 3 · PLANS LES PLUS PROCHES','AI CFO · QUESTION SUR CE SCÉNARIO']:
        assert x in t
